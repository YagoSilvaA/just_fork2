...
function save(req, res) {
    const menu = {
        ...
        restaurantId: req.restaurantData.restaurantId,
        userId: req.restaurantData.userId
    }
...
function update(req, res) {
    const id = req.params.id;
    const userId = req.restaurantData.userId;
    const restaurantId = req.restaurantData.restaurantId;
